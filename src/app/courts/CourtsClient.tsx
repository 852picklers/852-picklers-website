    ...
    <div className="min-h-screen bg-[#050505] text-white overflow-x-hidden relative">
      ...
      <main className="relative z-10 w-full max-w-[1400px] mx-auto px-4 md:px-6 py-16 md:py-20 flex flex-col gap-8 md:gap-10">
              ...
              <div className="flex flex-wrap gap-3 md:gap-4">
                {["ALL", "HK", "KLN", "NT"].map((r) => (
                  <button 
                    ...
                    className={`px-4 md:px-6 py-2 rounded-sm border text-xs md:text-sm font-bold uppercase tracking-widest transition-all duration-300 ${activeRegion === r ? "bg-neon-red text-white border-neon-red" : "border-white/20 text-gray-500 hover:text-white hover:border-white/50"}`}
                  >
        ...
        {filteredCourts.length === 0 ? (
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="w-full mt-2 md:mt-4">
             <div className="relative w-full bg-[#080808] border border-white/10 rounded-sm overflow-hidden flex flex-col md:flex-row">
                ...
                <div className="w-full md:w-7/12 p-8 md:p-16 flex flex-col justify-center">
                   ...
                   <Link href="/shop" className="bg-[#ccff00] px-8 py-3 w-fit text-black font-bold uppercase tracking-widest text-sm hover:scale-105 transition-transform">
                  ...
                  <div className="flex flex-col bg-[#0a0a0a] border border-white/10 rounded-sm overflow-hidden transition-all duration-300 hover:border-neon-red h-full">
                    <div className="relative w-full aspect-[4/3] bg-black">
                       <Image 
                        ...
                        alt={cName} 
                        fill 
                        quality={60} // 顯著優化：降低清單圖片質量
                        sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw" // 確保手機不加載原圖
                    ...
                    <div className="p-5 md:p-6 flex flex-col flex-grow gap-4">
                        ...
                        <p className="text-gray-400 text-xs md:text-sm line-clamp-2">{cAddress}</p>
